...
#define QP_VERSION_STR  "6.0.2"

//! Tamperproof current QP release (6.0.2) and date (2017-11-30)
#define QP_RELEASE      0x99FFA005U
...
extern char_t const versionStr[6];
    ...
    private:
        ...
        friend class QXThread;      // Gallium - fix bug
...
private:
    enum {
        MAX_NEST_DEPTH_ = 8  //!< maximum nesting depth of states in HSM
    };
